...
public class AirPlay {
    ...
    protected BufferedImage scaleImage(BufferedImage image) {
        ...
        if (width <= appletv_width && height <= appletv_height) {
            ...
            if (image_aspect > appletv_aspect) {
                scaledheight = Float.valueOf(appletv_width / image_aspect).intValue();
                scaledwidth = appletv_width;
            } else {
                scaledheight = appletv_height;
                scaledwidth = Float.valueOf(appletv_height * image_aspect).intValue();
            }
    ...
    public static class Service {
        ...
        public boolean equals(Object o) {
            ...
            return name.equals(that.name) && hostname.equals(that.hostname) && port == that.port;
        }
    }
